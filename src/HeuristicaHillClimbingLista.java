 ...
 * @author admin
 */
public class HeuristicaHillClimbingLista {
    ...
    public static int[] hillClimbing(int qtdeInteracoes, int qtdeRainha) {
        ...
        while ((interacao < qtdeInteracoes) && (verificaSolucao(candidato) == false)) {
            ...
            //TODO            
            //List vizinhos = gerarVizinhos(candidato);
            //Mudar para gerar uma lista dos vizinhos para o candidato
                        
            //Calcula o Custo do novo vizinho
            int custoVizinho = funcaoFitness(vizinho);
            //TODO
            //int[] vizinho = melhorVizinho(vizinhos)
            //Retornar o vizinho o maior custo
